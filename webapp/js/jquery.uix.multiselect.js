...
;(function($, window, undefined) {
    ...
    $.widget("uix.multiselect", {
            ...
            this._elementWrapper = $('<div></div>').addClass('uix-multiselect ui-widget')
                ...
                .append(
                    $('<div></div>').addClass('multiselect-selected-list')
                        .append( $('<div></div>').addClass('ui-widget-header')
                            .append( btnDeselectAll = $('<button><span class="ui-icon ui-icon-arrowstop-1-e" style="top:-2px;left:-8px;"></span></button>', { type:"button" }).addClass('uix-control-right')
                ...
                ['right,top'.indexOf(this.options.availableListPosition)>=0?'prepend':'append'](
                    $('<div></div>').addClass('multiselect-available-list')
                        .append( $('<div></div>').addClass('ui-widget-header')
                            .append( btnSelectAll = $('<button><span class="ui-icon ui-icon-arrowstop-1-w" style="top:-2px;left:-8px;"></span></button>', { type:"button" }).addClass('uix-control-right')
        ...
        _initSearchable: function() {
            ...
            if (isToggle) {
                var that = this;
                this._buttons['search'] = $('<button><span class="ui-icon 	ui-icon-search" style="top:-2px;left:-8px;"></span></button', { type:"button" }).addClass('uix-control-right')
