 ...
 */
class ExportAnswerQuestionSqlCommand extends CConsoleCommand {
    ...
    public function run($args) {
        ...
        $sql.= "\n";
        $sql.= 'CREATE TABLE ' . $table . ' (id int(11) NOT NULL AUTO_INCREMENT,answer varchar(255) NOT NULL,PRIMARY KEY (id));';
        $sql.= "\n";
