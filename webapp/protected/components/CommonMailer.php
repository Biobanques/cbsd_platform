...
class CommonMailer {
     ...
     */
    public static function sendConfirmationAdminProfilUser($user, $profil) {
...
Cliquez sur le lien ci-dessous ou copier l'adresse dans votre navigateur afin de finaliser la proc&eacute;dure de confirmation:
     ...
     * @return type
     */
    public static function sendUserRegisterConfirmationMail($user, $profil) {
        $to = $user->email;
    ...
    public static function sendUserRegisterRefusedMail($user, $profil) {
        $to = $user->email;
