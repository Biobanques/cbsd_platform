...
class CommonMailer {
     ...
     * from by default
     */
    const MAIL_FROM = "bernardte90@gmail.com";
     ...
     */
    function sendMailInscriptionUser($to, $identifiant, $prenom, $nom, $pass, $profil) {
                ...
                <td align=\"left\">Bonjour <strong style=\"color:#DB3484;\">" . $prenom . " " . $nom . "</strong>,</td>
                        ...
                        Nom d'utilisateur : <strong><span style=\"color:#DB3484;\">" . $identifiant . "</span></strong>
                                <br >Mot de passe : <strong>" . $pass . "</strong>
                                        ...
                                        <tr>
                                        <td align=\"left\">
                                        Vous pouvez d&egrave;s &agrave; pr&eacute;sent utiliser notre site internet <a href=\"" . $base . "\">cbsdplatform</a>.
                                        </td>
                                        </tr>
                                        <tr><td>&nbsp;</td></tr>
                                        <tr>
                                        <td align=\"center\" style=\"font-size:10px; border-top: 1px solid #D9DADE;\">
                                        <a href=\"" . $base . "\" style=\"color:#DB3484; font-weight:bold; text-decoration:none;\">
        ...
        CommonMailer::sendMail($to, $subject, $body, $profil);
    }
     ...
     */
    public static function sendMailConfirmationEmail($to, $identifiant, $prenom, $nom, $idUser, $profil) {
        $base = CommonMailer::DEV_URL;
        if (!CommonTools::isInDevMode()) {
            $base = CommonMailer::PROD_URL;
        }
     ...
     */
    public static function sendMailConfirmationProfilEmail($to, $prenom, $nom, $idUser, $profil, $complement) {
        $base = CommonMailer::DEV_URL;
        if (!CommonTools::isInDevMode()) {
            $base = CommonMailer::PROD_URL;
        }
        if ($complement == NULL)
            $urlConfirm = $base . "/index.php?r=site/confirmProfil&arg1=" . $idUser . "&arg2=" . $profil;
        else
            $urlConfirm = $base . "/index.php?r=site/confirmProfil&arg1=" . $idUser . "&arg2=" . $profil . "&arg3=" . $complement;

        $subject = "Confirmation de votre profil " . $profil;
        $body = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01//EN\" \"http://www.w3.org/TR/1999/REC-html401-19991224/strict.dtd\">
                <?xml version=\"1.0\" encoding=\"utf-8\"?>
                <html><head>
                ...
                <td align=\"left\">Bonjour <strong style=\"color:#DB3484;\">" . $prenom . " " . $nom . "</strong>,</td>
                        ...
                        Pour pouvoir vous connecter avec votre profil sur cbsdplatform, il nous faut confirmer votre identité.<br>
                        Pouvez-vous cliquer sur le lien ci-dessous ou copier l'adresse dans votre navigateur afin de finaliser la proc&eacute;dure de confirmation:
                        </td>
                        </tr>
                        <tr><td>&nbsp;</td></tr>
                        ...
                        <a href=\"" . $urlConfirm . "\">" . $urlConfirm . "</a>
                                ...
                                <tr>
                                <td align=\"left\">
                                Rendez-vous sur notre site internet <a href=\"" . $base . "\">cbsdplatform</a>.
                                </td>
                                </tr>
                                <tr><td>&nbsp;</td></tr>
                                <tr>
     ...
     * @return type
     */
    public static function sendSubscribeAdminMail($user, $profil) {
        ...
        $body = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01//EN\" \"http://www.w3.org/TR/1999/REC-html401-19991224/strict.dtd\">
                ...
                $user->prenom $user->nom s'est inscrit sur le site " . $base . ".<br>
                        Détails :<br>
    ...
    public static function sendSubscribeUserMail($user, $profil) {
        ...
        $body = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01//EN\" \"http://www.w3.org/TR/1999/REC-html401-19991224/strict.dtd\">
                ...
                <meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">
                                ...
                                Bienvenue " . $user->prenom . " " . $user->nom . " sur cbsdplatform.<br>
