...
return array(
    ...
    . CHtml::image(Yii::app()->request->baseUrl . '/images/annuler.png', '', array("width" => "15px", "height" => "15px")) . ' <b>Refuser tout</b> (la fiche actuelle sera conversée et la nouvelle fiche sera supprimée)<br>'
