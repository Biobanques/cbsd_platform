    ...
    <div style="border:1px solid black;">
        ...
        <div class="row buttons">
            <div class="col-lg-7 col-lg-offset-7">
                <?php echo CHtml::submitButton(Yii::t('common', 'search'), array('id' => 'restrictSearch', 'class' => 'btn btn-primary', 'style' => 'display:none;')); ?>
                <?php echo CHtml::resetButton(Yii::t('common', 'deleteQuery'), array('id' => 'restrictReset', 'class' => 'btn btn-danger', 'style' => 'display:none;', 'onclick' => 'location.reload();')); ?>
            </div>
        </div>
